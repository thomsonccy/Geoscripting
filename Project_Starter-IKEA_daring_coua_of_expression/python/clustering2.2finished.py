...
print('the accuracy without thermal data of kmeans in python is',silhouette_km)

silhouette_km_thermal = silhouette_score(scaled_multiGDF_clear, y)
print('the accuracy with thermal data of kmeans in python is',silhouette_km_thermal)
...
r = pd.read_csv('data/KMeans_Normalised_Polygon_data_with_Thermal.csv',sep=' ')

r_without_thermal = pd.read_csv('data/KMeans_Normalised_Polygon_data_without_Thermal.csv',sep=' ')

silhouette_km_r = silhouette_score(r.iloc[:, 0:(len(r.columns)-1)], r['cluster'])
...
# plot the score in bar chart

name_list = ['Kmeans (Python)','Clara (R)','GMM (Python)']

with_thermal = [silhouette_km_thermal , silhouette_km_r, silhouette_gmm]
no_thermal = [silhouette_km ,silhouette_km_thermal_r, silhouette_gmm_without_thermal]
